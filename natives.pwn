...
//@remarks {@param buf} data: <ul>\
	...
	<li>{@code buf+500}: tracker data to be sent to flight tracker, only when returned non-zero</li></ul>
...
//@remarks {@param buf} data: <ul>\
	...
	<li>{@code buf+200}: tracker data to be sent to flight tracker</li></ul>
