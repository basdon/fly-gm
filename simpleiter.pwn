...
#define iter_add_us(%1,%2) if(!(%1@h[%2]))%1[%1@c++]=%2,%1@h[%2]=%1@c
#define iter_add(%1,%2) %1@t=%2;iter_add_us(%1,%1@t)
#define iter_remove_us(%1,%2); if(%1@h[%2]){if(%1@h[%2]!=%1@c--){%1[%1@h[%2]-1]=%1[%1@c];%1@h[%1[%1@c]]=%1@h[%2];}%1@h[%2]=0;}
#define iter_remove(%1,%2); %1@t=%2;iter_remove_us(%1,%1@t)
